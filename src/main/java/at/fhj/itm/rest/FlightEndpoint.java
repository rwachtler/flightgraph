...
public class FlightEndpoint
{
   ...
   {
      em.persist(entity);
      return Response.created(UriBuilder.fromResource(FlightEndpoint.class).path(String.valueOf(entity.getId())).build()).build();
   }
   ...
   {
      TypedQuery<Flight> findByIdQuery = em.createQuery("SELECT DISTINCT f FROM Flight f LEFT JOIN FETCH f.departureAirport LEFT JOIN FETCH f.arrivalAirport WHERE f.id = :entityId ORDER BY f.id", Flight.class);
